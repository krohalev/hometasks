...
def to_roman(val):
    ...
    while val:
        ...
        if last_num <= 3:
            roman_str += roman_dict[div] * last_num
        elif last_num == 4:
            roman_str += roman_dict[div] + roman_dict[div * 5]
        elif 5 <= last_num <= 8:
            roman_str += roman_dict[div * 5] + (roman_dict[div] * (last_num - 5))
        else:
            roman_str += roman_dict[div] + roman_dict[div * 10]
